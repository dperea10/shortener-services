...
from application.shortened.usecase.get_all_short_url_used_usecase import get_all_short_url_used_use
from infra.handlers.dtos.response import ResponseDTO

def get_all_short_url_used_handler(token: str) -> ResponseDTO:
